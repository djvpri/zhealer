...
module.exports = {
  ...
  ZOMET_APPS: [
    { slug: 'zone',       name: 'Z One',        healthUrl: 'https://zone.zomet.my.id/api/health' },
    ...
    { slug: 'zgym',       name: 'ZGym',         healthUrl: 'https://zgym.zomet.my.id/api/health' },
    { slug: 'zbarber',    name: 'ZBarber',      healthUrl: 'https://zbarber.zomet.my.id/api/health' },
    { slug: 'ztransport', name: 'ZTransport',   healthUrl: 'https://ztransport.zomet.my.id/api/health' },
    { slug: 'zlaundry',   name: 'ZLaundry',     healthUrl: 'https://zlaundry.zomet.my.id/api/health' },
    { slug: 'zbilliar',   name: 'ZBilliar',     healthUrl: 'https://zbilliar.zomet.my.id/api/health' },
    { slug: 'zprint',     name: 'ZPrint',       healthUrl: 'https://zprint.zomet.my.id/api/health' },
    { slug: 'zwisata',    name: 'ZWisata',      healthUrl: 'https://zwisata.zomet.my.id/api/health' },
    { slug: 'zanalytics', name: 'Z Analytics',  healthUrl: 'https://zanalytics.zomet.my.id/api/health' },
    { slug: 'zadv',       name: 'ZAdv',         healthUrl: 'https://zadv.zomet.my.id/api/health' },
    { slug: 'zbackup',    name: 'ZBackup',      healthUrl: 'https://zbackup.zomet.my.id/api/health' },
    { slug: 'zbanker',    name: 'Z Banker',     healthUrl: 'https://zbanker.zomet.my.id/api/health' },
  ]
}
