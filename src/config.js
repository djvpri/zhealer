...
module.exports = {
  ...
  ZOMET_APPS: [
    ...
    { slug: 'ztransport', name: 'ZTransport',  healthUrl: 'https://ztransport.zomet.my.id/api/health', githubRepo: 'ZTransport' },
    ...
    { slug: 'zadv',       name: 'ZAdv',        healthUrl: 'https://zadv.zomet.my.id/api/health',       githubRepo: 'Zadv' },
    { slug: 'zbackup',    name: 'ZBackup',     healthUrl: 'https://zbackup.zomet.my.id/api/health',    githubRepo: null },
